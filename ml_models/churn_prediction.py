...
def load_user_features():
    ...
    SELECT ua.*, ut.user_tier,
           CURRENT_DATE - ua.last_active as days_since_last,
           CASE WHEN CURRENT_DATE - ua.last_active > 30 THEN 1 ELSE 0 END as churned
